...
- [第 0 步 · 先确认两件事](#第-0-步--先确认两件事)
- [第 1 步 · 造 SQL 载体](#第-1-步--造-sql-载体)
- [第 2 步 · 填 serverScript 与 sql](#第-2-步--填-serverscript-与-sql)
- [第 3 步 · 校验 SQL 载体](#第-3-步--校验-sql-载体)
- [第 4 步 · 造页面](#第-4-步--造页面)
- [第 5 步 · 把控件树搭进去](#第-5-步--把控件树搭进去)
- [第 6 步 · 核对传参](#第-6-步--核对页面--store--sql-的传参)
- [第 7 步 · 格式与命名校验](#第-7-步--格式与命名校验)
- [第 8 步 · 登记进 folder.json](#第-8-步--登记进-folderjson)
- [第 9 步 · 交付前自检](#第-9-步--交付前自检)
- [出错了怎么回退](#出错了怎么回退)
...
> 跨 5 个工程实测最大的 746 KB 也仍在 1 s 上下）。
...
| `@itemId` 报重名 | 工具**不猜顺序**，会列候选清单。照清单选，或用 `@名字#N` 点名（见 SKILL.md §3.1） |
